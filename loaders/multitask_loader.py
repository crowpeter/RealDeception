...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 18 22:33:38 2022
...
class aac_speech_fusion_Dataset_multitask(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        y_data = np.array(self._Y[idx])
        if 1 in y_data:
            mil_label = np.array([[1]])
        else:
            mil_label = np.array([[0]])
        # pdb.set_trace()
        return output_data, y_data, mil_label  
    

class aac_speech_fusion_Dataset_multitask_analysis(Dataset):
    def __init__(self, ep_keys, eps_path, feature_root, wrap_len, conversation=False, func=None, label_weighted=False):
    ...
    def __getitem__(self, idx):
        ...
        if 1 in y_data:
            ...
            mil_label = np.array([[0]])
        # pdb.set_trace()
        return output_data, y_data, mil_label, self._X[idx]

class aac_concate_speech_fusion_Dataset_multitask(Dataset):
    def __init__(self, ep_keys, eps_path, feature_root, wrap_len, conversation=False, func=None, label_weighted=False):
